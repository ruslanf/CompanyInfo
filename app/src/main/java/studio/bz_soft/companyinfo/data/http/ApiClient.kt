...
import studio.bz_soft.companyinfo.BuildConfig
...
//            .connectionSpecs(Collections.singletonList(connectionSpec))
    ...
    override suspend fun getCompaniesList(): List<CompaniesModel> = apiClient.getCompanies()

    override suspend fun getCompanyInfo(id: Int): List<CompanyModel> = apiClient.getCompanyInfo(id)
